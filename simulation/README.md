...
Clone this repository (or download and extract its ZIP), then open a terminal in its `simulation/` directory. All commands in this guide run from that directory:
